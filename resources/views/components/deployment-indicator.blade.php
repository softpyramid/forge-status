<div id="forge-deployment-indicator" 
     class="fixed {{ config('forge-status.position') === 'top-right' ? 'top-4 right-4' : '' }}
            ...
            {{ config('forge-status.position') === 'bottom-right' ? 'bottom-4 right-4' : '' }}
            {{ config('forge-status.position') === 'bottom-left' ? 'bottom-4 left-4' : '' }}
            z-50 hidden transition-all duration-300">
    
    <div class="bg-white rounded-lg shadow-lg border border-gray-200 px-4 py-3 flex items-center space-x-3 min-w-[250px]">
        <!-- Deploying Spinner -->
        <div id="forge-status-deploying" class="hidden">
        ...
        <!-- Success Icon -->
        <div id="forge-status-success" class="hidden">
        ...
        <!-- Failed Icon -->
        <div id="forge-status-failed" class="hidden">
        ...
        <div class="flex-1">
            <p id="forge-status-text" class="text-sm font-medium text-gray-900">Checking status...</p>
            <p id="forge-status-detail" class="text-xs text-gray-500"></p>
        </div>
